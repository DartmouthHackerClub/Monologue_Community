...
<form method="post"> 
	...
	<ul style="list-style:disc inside;">
		...
		<li style="color: #000000;font-size: 14px;">Using the HybridAuth installer will erase your the existen configuration file. If you already have an old installation of HybridAuth you might keep a copy of hybridauth/hybridauth.php file,</li>
